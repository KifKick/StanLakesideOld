...
switch (_shop) do
{
	...
	case "cop": {["Przedmioty policyjne",["redgull","cigarette","tbacon","medkit","panicbutton","bandage","fuelF","defusekit","BarGate","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB"]]};
