...
if((_this select 3) == "oskp" && !license_civ_oskp) exitWith {["Won mi stad plebsie.", false] spawn domsg; closeDialog 0;};
if((_this select 3) == "prokurator" && playerSide != west) exitWith {["...", false] spawn domsg; closeDialog 0;};
