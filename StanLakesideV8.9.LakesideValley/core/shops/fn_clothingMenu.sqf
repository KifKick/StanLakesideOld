...
if((_this select 3) == "oskp" && !license_civ_oskp) exitWith {["Won mi stąd plebsie.", false] spawn domsg; closeDialog 0;};
if((_this select 3) == "prokurator" && !license_cop_prokurator) exitWith {["...", false] spawn domsg; closeDialog 0;};
