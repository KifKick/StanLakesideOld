...
[] spawn {
	while{true} do {
		[1,format["URZAD PRACY: Mobilne pojazdy sprzedazy znikna za minute!"]] remoteExecCall ["life_fnc_broadcast", civilian];
		uiSleep 30;
		[1,format["URZAD PRACY: Mobilne pojazdy sprzedazy znikna za 30 sekund!"]] remoteExecCall ["life_fnc_broadcast", civilian];
		uiSleep 30;
		{
		...
		[1,format["URZAD PRACY: Zwolnily sie miejsca w pracy!"]] remoteExecCall ["life_fnc_broadcast", civilian];
