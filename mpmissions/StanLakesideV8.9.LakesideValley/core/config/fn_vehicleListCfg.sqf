...
switch (_shop) do
{
	...
	case "cop_car":
	{
		...
		[
			...
			["A3L_CVPI_Corrections_LB",200000],
			["cg_ss2",200000],
			["cg_CVPIFPBLBPD",200000],
			["A3L_CVPI_Sheriff_Slick",200000],
			...
			["A3L_CVPIUCRed",20000],
			["cg_audi_rs4_pol_noir",20000],
			["cg_peugeot_508_pol_d",25000],
			["cg_mercedes_sprinter_pol_base_reg",1],
			...
			["A3L_Suburban_UM_Black",40000],
			["A3L_Suburban_White",40000],
