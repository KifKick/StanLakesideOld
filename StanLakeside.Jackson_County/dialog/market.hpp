...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Market Stanu Lakeside</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1101;
			text = "<t align='center'>Zmiany w rynku</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "Od startu serwera"; //--- ToDo: Localize;
