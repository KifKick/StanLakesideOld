...
[
			...
			["ivory_suburban",6600],
			["ivory_veyron",42200],
			["shounka_f430_spider_bleufonce",35000],
			["bv_458_2tone1",37000],
			["bv_458_black2",37000],
			...
			["Jonzie_Box_Truck",10000],
			//["Jonzie_Tanker_Truck",12000],
			["Jonzie_Tow_Truck",4000],



			["shounka_avalanche_bleufonce",7000],
			["shounka_avalanche_grise",7000],
			["shounka_avalanche_jaune",7000],
			["shounka_avalanche_noir",7000],
			["shounka_avalanche_orange",7000],
			["shounka_avalanche_rose",7000],
			["shounka_avalanche_rouge",7000],
			["shounka_avalanche_violet",7000],


			["shounka_ivceco_bleufonce",11000],
			["shounka_ivceco_grise",11000],
			["shounka_ivceco_jaune",11000],
			["shounka_ivceco_noir",11000],
			["shounka_ivceco_orange",11000],
			["shounka_ivceco_rose",11000],
			["shounka_ivceco_rouge",11000],
			["shounka_ivceco_violet",11000],

			["Nhz_audia8limo",33000],

			["cg_audi_a8_limo_noir",41900],
			["cg_audi_a8_limo_violet",41900],
			["cg_audi_a8_limo_rose",41900],
			["cg_audi_a8_limo_orange",41900],
			["cg_audi_a8_limo_grise",41900],
			["cg_audi_a8_limo_vert",41900],
			["cg_audi_a8_limo_bleufonce",41900],
			["cg_audi_a8_limo_bleu",41900],
			["cg_audi_a8_limo_white",41900],
			["cg_audi_a8_limo_jaune",41900],

			["wirk_h3_limo",51300],
			["shounka_buggy_bleufonce",41300],
			["A3L_Towtruck",2000],
