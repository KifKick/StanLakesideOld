...
switch (_filter) do
{
	...
	case 1: //Czapki
	{
		...
		[
			...
			["ACE_helmet","Helm pilota",5],
			["wing_helmet","Helm pilota",5],
			["TCG_pdav_helmet","Helm Co-pilota",5],
	...
	case 2: //Okulary
	{
		...
		[
			...
			["Mask_M40","Maska MP-6",5],
			["Mask_M40_OD","Maska MP-6 Olive",5]
