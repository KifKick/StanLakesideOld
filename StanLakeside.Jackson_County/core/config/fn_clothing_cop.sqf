...
switch (_filter) do
{
	...
	case 3: //Kamizelki
	{
		...
		[
			...
			["kif_bureau_kali_vest","Bureau Kali Alcatraz",15],
			["kif_bureau_kevin_vest","Bureau Kevin McCallister",15],
			["kif_bureau_iza_vest","Bureau Iza Elric",15],
			["kif_sheriff_commander_dorian_vest","SO Commander Dorian Lych",15],
			["kif_sheriff_commander_lych_vest","SO Commander D. Lych",15],
			["kif_sheriff_lakeside_vest_dorian","SO Vest Dorian Lych",15],
			["kif_sheriff_lakeside_vest_mike","SO Vest Mike Williams",15],
			...
			["kif_lspd_police_department_sgt_kraksa_vest", "LSPD Sgt. P. Kraksa Vest", "15"],
			["kif_lspd_police_department_sgt_czajka_vest", "LSPD Sgt. A. Czajka Vest", "15"],
			["kif_lspd_police_department_sgt_katsu_vest", "LSPD Sgt. N. Katsu Vest", "15"],
			["kif_lspd_police_department_sgt_basta_vest", "LSPD Sgt. A. Basta Vest", "15"],
			...
			["kif_supervisor_sheriff_vest_dorian", "SO Supervisor Dorian", "15"],
