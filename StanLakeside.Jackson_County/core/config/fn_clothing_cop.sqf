...
switch (_filter) do
{
	case 0: //Mundury
	{
		...
		[
			...
			["RF_WING_3",nil,15],
			["TRYK_U_B_BLK","Mundur Co-Pilota",15],
	...
	case 1: //Czapki
	{
		...
		[
			...
			["jamie_pcapblue","Czapka Cadet",5],
			["jamie_pcapblack","Czarna Akcje Policja",5],
			["KMC_Cap_po1","Czarna PO1",5],
			["KMC_Cap_po2","Czarna PO2",5],
			["KMC_Cap_po3","Czarna PO3",5],
			["KMC_Cap_po4","Czarna PO4",5],
			["KMC_Cap_po5","Czarna PO5",5],
			["KMC_Cap_po6","Czarna PO6",5],
			["KMC_Cap_sgt","Czarna Sgt",5],
			["KMC_Cap_ssgt","Czarna SSgt",5],
			["KMC_Cap_msgt","Czarna MSgt",5],
			["KMC_Cap_DTU1","Czarna DTU 1",5],
			["KMC_Cap_DTU2","Czarna DTU 2",5],
			["KMC_Cap_DTU3","Czarna DTU 3",5],
			["KMC_Cap_DTU4","Czarna DTU 4",5],
			["KMC_Cap_SERT","Czarna S.E.R.T.",5],
	...
	case 3: //Kamizelki
	{
		...
		[
			...
			["dryg_bureau_derek_vest","LSPD CB",15],
			["kif_bureau_kali_vest","LSPD CB K.Alcatraz",15],
			["kif_bureau_kevin_vest","LSPD CB K.McCallister",15],
			["dryg_lspd_police_department_lt_basta_vest",nil,20],
			["dryg_lspd_police_department_lt_dzoka_vest",nil,20],
			["dryg_lspd_police_department_ssgt_minato_vest",nil,20],
			["dryg_lspd_police_department_sgt_waltz_vest",nil,20],
			["kif_lspd_police_department_vest", "LSPD High", 15],
			["kif_supervisor_vest_lspd", "Supervisor LSPD", 15],
			["dryg_supervisor_captain_rudolf_vest_lspd", "Rudolf Supervisor LSPD", 15],
			["dryg_gu_vest", nil, 15],
			["dryg_gu_florian_vest", nil, 15],
			["dryg_gu_marian_vest", nil, 15],
			["dryg_gu_easy_vest", nil, 15],
			["kif_dtu_vest_lspd",nil,15],
			...
			["dryg_aiad_vest_naburo",nil,15],
			["dryg_aiad_vest_lamar",nil,15],
			...
			["dryg_sheriff_vest","SO Black Vest",15],
			...
			["dryg_sheriff_ls_walezy_vest", "SO Walezy", 15],
			["dryg_sheriff_ls_kappovsky_vest", "SO Kappovsky", 15],
			["A3L_EC_PATROL_VEST","Sheriff Krotka",15],
			["kif_sheriff_traffic_vest","Sheriff Drogowka",20],
			["kif_traffic_vest","Kamizelka Drogowka",20],
			["TAC_Sheriff_BA_OD","Sheriff Kamizelka",20],
			["TAC_PBDFG2CPSRF_RG_1","Sheriff Kamizelka",20],
			...
			["dryg_lspd_police_department_ssgt_bolec_vest",nil,20],
