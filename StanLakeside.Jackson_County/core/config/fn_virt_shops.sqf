...
switch (_shop) do
{
	...
	case "cop": {["Przedmioty policyjne",["medkit","panicbutton","cigarette","bandage","fuelF","defusekit","BarGate","RoadBlockWood","RoadCone","RoadConeStrip","RoadConeB","RoadConeStripB"]]};
