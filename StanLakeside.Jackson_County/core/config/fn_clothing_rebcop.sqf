...
//Shop Title Name
ctrlSetText[3103,"Sklep z ubraniami rebelii dla DTU"];
...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["I_FEM_AAF_long","Female Long",550],
			["B_FEM_AAF_Rolled","Female Rolled",550],
			["B_FEM_NATO_Rolled","Female Rolled 3",550],
			["U_C_DDE","Kombinezon HazMat / Uran",550],


			["U_I_pilotCoveralls",nil,550],
			["U_IG_Guerilla1_1",nil,550],
			["U_I_G_Story_Protagonist_F",nil,550],
			["U_I_G_resistanceLeader_F",nil,550],
			["U_IG_leader","Guerilla Leader",550],
			["U_I_GhillieSuit",nil,550],
			["U_I_FullGhillie_lsh",nil,550],
			["U_B_FullGhillie_lsh",nil,550],


			//TRYK


			["TRYK_B_USMC_R_ROLL","Green Top, MARPAT Pants",550],
			["TRYK_U_B_NATO_OCP_BLK_R_CombatUniform","Black Top, ACU Pants",550],
			["TRYK_U_B_AOR2_GRY_CombatUniform","Grey Top, DigiGreen Pants",550],	
			["TRYK_U_B_ARO1_CBR_CombatUniform","Desert Camo",550],
			["TRYK_U_B_Snow_CombatUniform","Snow Camo",550],

			["TRYK_U_B_AOR2_OD_CombatUniform","Green Top, DigiGreen Pants",550],
			["TRYK_U_B_AOR2_BLK_CombatUniform","Black Top, DigiGreen Pants",550],
			["TRYK_DMARPAT_T","Brown Top, DigiTan Pants",550],
			["TRYK_U_B_ARO1_BLK_CombatUniform","Black Top, DigiTan Pants",550],
			["TRYK_U_B_ARO1_CombatUniform","DigiTan Full",550],
			["TRYK_U_B_NATO_OCP_R_CombatUniform","DigiGreen Full",550],
			["TRYK_U_B_MARPAT_Wood","MARPAT Full",550],
			["TRYK_U_B_NATO_OCP_R_CombatUniform","OCP Full",550],

			["TRYK_SUITS_BLK_F","TRYK Black Suit",550],
			["TRYK_SUITS_BR_F","TRYK Brown Suit",550],
